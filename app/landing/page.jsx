...
export default function page() {
    return (
        <div >
            <main >
                <WavyBackground className="w-full py-16 sm:py-24 md:py-32 lg:py-40 xl:py-48 relative">
                    ...
                    <div className="flex-1 container px-4 md:px-6 text-center">
                        <div className="max-w-3xl mx-auto space-y-4">
                            ...
                            <div className="flex justify-center mt-6">
                                <Link
                                    href="/auth"
                                    className="inline-flex h-10 items-center justify-center rounded-md bg-primary-foreground px-8 text-sm font-medium text-primary shadow transition-colors hover:bg-primary/20 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
                                    prefetch={false}
                                >
                                    Get Started
                                </Link>
